...
const __filename = fileURLToPath(import.meta.url); // /app/dist/app.js
const __dirname = path.dirname(__filename); // /app/dist
const __rootdir = path.resolve(__dirname, ".."); // /app
