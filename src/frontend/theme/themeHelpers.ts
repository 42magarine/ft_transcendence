...
// Card styling
export function themedCard(theme: ThemeName): string {
	switch (theme) {
		case 'stars':
...
// Input styling
export function themedInput(theme: ThemeName): string {
	return `input-glass input-theme-${theme} focus:outline-none focus:ring-3 focus:border-white/40 w-full`;
}

// Label styling
export function themedLabel(theme: ThemeName): string {
	switch (theme) {
		case 'stars':
...
export function themedStat(theme: ThemeName): string {
	switch (theme) {
		case 'stars':
...
// Main title styling
export function themedTitle(theme: ThemeName): string {
	switch (theme) {
		case 'stars':
			return 'text-white';
		case 'mechazilla':
...
// Subtitle styling
export function themedSubtitle(theme: ThemeName): string {
	switch (theme) {
		case 'stars':
...
// Toggle styling
export function themedToggle(theme: ThemeName): string {
	switch (theme) {
		case 'stars':
			return 'bg-gray-600';
		case 'mechazilla':
...
export function themedToggleLabel(theme: ThemeName): string {
	switch (theme) {
		case 'stars':
			return 'text-white';
		case 'mechazilla':
...
export function getThemeBackground(theme: ThemeName): string {
	switch (theme) {
		case 'stars':
